#!/bin/bash
# verify_fr.acinq.phoenix.mainnet.sh v1.0.0 - Standalone verification script for Phoenix Lightning Network wallet
# Combines functionality from test.sh and phoenix build logic
# Usage: verify_fr.acinq.phoenix.mainnet.sh -a path/to/phoenix.apk [-r revisionOverride] [-n] [-c]
...
usage() {
  echo 'NAME
       verify_fr.acinq.phoenix.mainnet.sh - verify Phoenix Lightning Network wallet build

SYNOPSIS
       verify_fr.acinq.phoenix.mainnet.sh -a downloadedApk [-r revisionOverride] [-n] [-c]
